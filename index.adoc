...
3. Comprueba el nombre de tu interfaz de red (puede ser eth0 o ens3): 

`ifconfig`

El nombre de tu interfaz de red puede ser **eth0**, con valor de MTU incorrecto:

image:ifconfig_eth0_mtu_incorrecto.png[interfaz de red puede eth0]

O bien **ens3**, con valor de MTU incorrecto:

image:ifconfig_ens3_mtu_incorrecto.png[interfaz de red puede eth0]

3. Modificar el tamaño MTU actual, en fución del nombre anterior
    
`ifconfig eth0 mtu 1450`

O bien 

`ifconfig ens3 mtu 1450`
...
O bien el archivo `/etc/network/interfaces.d/50-cloud-init.cfg`
...
iface ens3 inet dhcp
    post-up /sbin/ifconfig ens3 mtu 1450 <2>
----
<2> Añadir esta línea para configurar la MTU tras el arranque
...
6. Tras reniciar, comprobamos con ifconfig que el valor de MTU es correcto (1450)


image:ifconfig_eth0_mtu_1450.png[interfaz de red puede eth0 correcto]

O bien

image:ifconfig_ens3_mtu_1450.png[interfaz de red puede ens3 correcto]
